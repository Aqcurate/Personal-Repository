...
public class ElevensBoard extends Board {
	...
	public boolean anotherPlayIsPossible() {
		...
		return containsPairSum11(currentBoard) || containsJQK(currentBoard);
	}
	...
	private boolean containsPairSum11(List<Integer> selectedCards) {
		...
		for (int point : cardPoints) {
			if (cardPoints.contains(11-point)) return true;
		}
	...
	private boolean containsJQK(List<Integer> selectedCards) {
		...
		for (int index : selectedCards) {
			if (super.cardAt(index).getRank() == "king") hasKing = true;
			if (super.cardAt(index).getRank() == "queen") hasQueen = true;
			if (super.cardAt(index).getRank() == "jack") hasJack = true;
		}
